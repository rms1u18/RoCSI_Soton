...
cd Desktop/Soton/Soton_18S_RNA
...
qiime phylogeny align-to-tree-mafft-fasttree \
 ...
 # I chose 34 - the feature count is particular low for these samples I have chose 34 but this still omits lots of samples and includes lots of blanks - these results look very messy.
